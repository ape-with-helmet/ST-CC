#CReate a new branch names "feature-branch". Switch to the master branch and merge the feature branch into the master branch.
#Stash your changes, switch changes and apply the stahsed changes.
#commands used: 
